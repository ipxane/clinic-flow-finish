                ...
                {value ? (
                    <>
                        ...
                        {!isUploading && showSuccess && (
                            <div className="absolute inset-0 flex flex-col items-center justify-center bg-green-500/80 backdrop-blur-sm z-10 animate-in fade-in duration-200">
                                <CheckCircle className="h-8 w-8 text-white mb-2" />
                                <span className="text-sm font-medium text-white">Uploaded!</span>
                            </div>
                        )}
                        {!isUploading && !showSuccess && (
