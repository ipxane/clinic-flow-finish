...
const navItems = [
  { to: "/system/dashboard", icon: LayoutDashboard, label: "Dashboard" },
  { to: "/system/patients", icon: Users, label: "Patients" },
  { to: "/system/services", icon: Stethoscope, label: "Services" },
  { to: "/system/booking-requests", icon: CalendarClock, label: "Booking Requests" },
  { to: "/system/appointments", icon: Calendar, label: "Appointments" },
