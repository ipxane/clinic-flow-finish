      ...
      <div className="flex items-center gap-4">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80 mt-2 p-0 overflow-hidden rounded-lg shadow-xl border-border">
                ...
                notifications.map((notification) => (
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      ...
                      navigate("/system/booking-requests");
                    }}
                  >
            ...
            <DropdownMenuItem
              ...
              onClick={() => navigate("/system/booking-requests")}
            >
              View all requests
            </DropdownMenuItem>
          </DropdownMenuContent>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-60 mt-2 p-1 rounded-lg shadow-xl border-border">
            ...
            <DropdownMenuItem onClick={() => navigate("/system/settings")} className="rounded-md mx-1 my-0.5 p-2 font-medium">
